...
import useAdminLogout from "../hooks/AdminLogin/useAdminLogout";
...
const Sidebar = () => {
  ...
  return (
    <div
      className="h-screen p-3 space-y-2 w-60 dark:bg-gray-50 dark:text-gray-800 font-khmer"
      bis_skin_checked="1"
    >
        ...
        <ul className="pt-2 pb-4 space-y-6 text-sm">
          ...
          <li>
            <Link
              ...
              className={`flex items-center p-2 space-x-3 rounded-md ${isActive("/admin/dashboard/product") ? "bg-gray-300" : ""}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <li>
            <Link
              ...
              className={`flex items-center p-2 space-x-3 rounded-md ${isActive("/admin/dashboard/inventory") ? "bg-gray-300" : ""}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <li>
            <Link
              ...
              className={`flex items-center p-2 space-x-3 rounded-md ${isActive("/admin/dashboard/orders") ? "bg-gray-300" : ""}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
