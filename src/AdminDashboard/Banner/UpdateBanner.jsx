...
import useUpdateBanner from "../../hooks/AdminBanner/useUpdateBanner";
import AdminHero from "../AdminHero";
import Sidebar from "../Sidebar";
import Loading from "../Loading";
const UpdateBanner = () => {
  const { preview, loading, navigate, handleImageChange, handleUpdateBanner } =
    useUpdateBanner();
  ...
  return (
    <>
      <div className="flex gap-2">
        <Sidebar />
        <AdminHero>
          <h1 className="text-[35px] p-2 font-bold">Update Banner</h1>
